					...
					<div className="clearfix">
						...
						<div className="pull-right socialmedia">
							<div className="clearfix si-share si-borderless social-share">
								<div>
									<a href="https://www.facebook.com/abc" className="social-icon si-borderless si-facebook">
										<i className="icon-facebook"></i>
										<i className="icon-facebook"></i>
									</a>
									<a href="https://twitter.com/abc" className="social-icon si-borderless si-twitter">
									...
									<a href="https://www.instagram.com/abc/?hl=en" className="social-icon si-borderless si-instagram">
